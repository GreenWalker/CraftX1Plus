...
public class ItemCreateUtil {
    ...
    public static ItemStack paneColor(String name, int amount, short variable, String... lore) {
        ItemStack item = new ItemStack(Material.STAINED_GLASS_PANE, amount, variable);
    ...
    public static ItemStack addMaterialLore(Material m, String nome, String... lore) {
        ItemStack item = new ItemStack(m);
        ItemMeta meta = item.getItemMeta();
        meta.setLore(Arrays.asList(lore));
        meta.setDisplayName(nome);
    ...
    public static ItemStack add(Material m, String nome, String[] lore, Enchantment enchant, int lvl, boolean hide) {
        ItemStack item = new ItemStack(m);
